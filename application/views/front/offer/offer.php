...
<head>
    ...
    <title>Raw Squeezed || Offers</title>
        ...
        <section class="section-p-30px add_block_2" >
            <div class="container-fluid">
                <ul class="row">
                    ...
                    ?>
                    <li class="col-sm-4 animate fadeInLeft " data-wow-delay="0.4s" > <img src="../../uploads/discount_image/<?php echo $row['image']; ?>" alt=""/> </li>
<!--                    <li class="col-sm-4 animate fadeInUp" data-wow-delay="0.4s"> <img src="../../images/offers/a2.png" alt=""></li>-->
<!--                    <li class="col-sm-4 animate fadeInRight" data-wow-delay="0.4s"> <img src="../../images/offers/a3.png" alt=""> </li>-->
                    <?php } ?>
                </ul>
