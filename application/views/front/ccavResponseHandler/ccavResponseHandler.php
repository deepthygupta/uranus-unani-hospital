                        ...
                        <div class=" ">
                            <div class="row ">
                                ...
                                <div class="col-sm-12 text-center" >
                                    ...
                                    <hr>
                                    <p>Your order is: # <?php $information=explode('=',$decryptValues[0]); echo $information[1]; ?>. </p>
                                ...
                                <div class="col-sm-6 well" style="margin-left:300px;text-align:left;">

                                    <h6> Shipping address</h6>
                                    <hr>

                                    <p>	<?php $information=explode('=',$decryptValues[11]); echo $information[1]; ?> <?php " " ?> <?php   ?> </p>
                                    <p>	<?php $information=explode('=',$decryptValues[12]); echo $information[1]; ?>,<?php $information=explode('=',$decryptValues[13]); echo $information[1]; ?>,<?php echo $information[14]; ?><?php echo $information[1]; ?></p>

                                    <p>	<?php $information=explode('=',$decryptValues[15]); echo $information[1]; ?>   </p>

                                    <p>	<?php $information=explode('=',$decryptValues[17]); echo $information[1]; ?> </p>
                                    <p>	<?php $information=explode('=',$decryptValues[18]); echo $information[1]; ?> </p>
                                    <p><Strong>	Grand Total </strong>
                                        <i class="fa fa-inr" aria-hidden="true"></i> <?php $information=explode('=',$decryptValues[10]); echo $information[1]; ?>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <!--                                <hr>-->
                                    <!---->
                                    <!--                                <p>	--><?php //$information=explode('=',$decryptValues[19]); echo $information[1]; ?><!-- --><?php //" " ?><!-- --><?php //  ?><!-- </p>-->
                                    <!--                                <p>	--><?php //$information=explode('=',$decryptValues[20]); echo $information[1]; ?><!--,--><?php //$information=explode('=',$decryptValues[21]); echo $information[1]; ?><!-- ,--><?php //echo $information[22]; ?><!----><?php //echo $information[1]; ?><!--</p>-->
                                    <!---->
                                    <!--                                <p>	--><?php //$information=explode('=',$decryptValues[23]); echo $information[1]; ?><!--   </p>-->
                                    <!---->
                                    <!--                                <p>	--><?php //$information=explode('=',$decryptValues[25]); echo $information[1]; ?><!-- </p>-->
                                    <!--                                    <p><Strong>	Grand Total </strong></p>-->
                                    <!---->
                                    <!--                                    <p><i class="fa fa-inr" aria-hidden="true"></i> --><?php // $information=explode('=',$decryptValues[10]); echo $information[1]; ?><!--</p>-->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table ">
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-inr" aria-hidden="true"></i> 	<?php $information=explode('=',$decryptValues[10]); echo $information[1]; ?></td>
                ...
                <div class="container">
                    ...
                    <div class="payment_steps">
                        <ul class="row">
                            ...
                            <!-- ORDER COMPLETE -->
                            <li class="col-sm-4 current"> <i class="fa fa-times"></i>
                    ...
                    <!-- Payments Steps -->
                    <p><strong>  Thank you for shopping with us.We will keep you posted regarding the status of your order through e-mail </strong></p>
        ...
        <div class="content">
            ...
            <section class="section-p-30px pages-in chart-page">
                <div class="container">
                    ...
                    <!-- Payments Steps -->
                    <p><strong>  Thank you for shopping with us.However,the transaction has been declined. </strong></p>
