        ...
        <div class="col-sm-12"> 
         ...
         <div class="">
            <div class=""> 
              <!--======= FORM  =========-->
                <?php
                echo form_open(base_url() . 'index.php/home/guest_login1', array(
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
					...
					<li class="col-md-6">
                      <label> *LAST NAME
                        <input type="text" name="surname" value="" placeholder="Last Name" required>
                      </label>
                    </li>
                     <li class="col-md-6">
                      <label> *PHONE NO
					  ...
					  <li class="col-md-12">
                      <label> *ADDRESS
                        <input type="text" name="address1" value="" placeholder="Address" required>
                      </label>
                    </li>
					<li class="col-md-4">
                      <label> *CITY
					...
					<li class="col-md-4">
                      <label> *PIN CODE 
                        <input type="text" name="zip" value="" placeholder="Pin Code" required >
                      </label>
                    </li>
					  ...
					  <li class="col-sm-12 ">
<!--                          <input type="submit" value="LOGIN AS GUEST" class="btn" id="btn_submit">-->
<!--                          <button type="submit" value="" class="btn" id="btn_submit"> LOGIN AS GUEST</button>-->
                          <button type="submit" value="submit" class="btn btn-dark" >LOGIN AS GUEST</button>
