...
?>
    ...
    <div class="order fix-length" style="height:250px;background-color:#f5f6f7">	
        <div class="buttons">
			...
			<form action="#">
			schedule a date:<br>
			<input type="date" name="" placeholder="mm/dd/yyyy" required>
			</form>
			...
			<div class="iteamenu" >
			<h6> Appleeeeeeeee <i class="fa fa-plus"></i> Green <i class="fa fa-plus"></i> Orange </h6>
