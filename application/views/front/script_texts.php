<script>
    ...
    var pin_available = "<?php echo translate('pin_code_available'); ?>";
    var pin_unavailable = "<?php echo translate('pin_code_not_available'); ?>";
...
<script type="text/javascript">
    ...
    //        notify(<?php //echo $this->session->flashdata('msg'); ?>//,'success');
    //    });
    //    <?php //} ?>
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data == 'success'){
                    ...
                    setTimeout(function(){redirect_page()}, 2000);
    ...
    $("body").on('click','.recovery_btn',function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data == 'success'){
                    $('.closeModal').click();
                    notify('<?php echo "Verification email sent"; ?>','success','bottom','right');
                    setTimeout(function(){redirect_page()}, 2000);
                    //sound('successful_login');
                } else if(data == 'user not found'){
                    notify('<?php echo "User not found"; ?>','warning','bottom','right');
                    //sound('unsuccessful_login');
                    setTimeout(function(){reload_page()}, 2000);
                }
                else if(data == 'password changed'){
                    $('.closeModal').click();
                    notify('<?php echo "Password changed successfully"; ?>','success','bottom','right');
                    setTimeout(function(){redirect_page()}, 2000);
                    //sound('successful_login');
                }
                else if(data == 'expired'){
                    notify('<?php echo "Link expired"; ?>','warning','bottom','right');
                    //sound('unsuccessful_login');
                    setTimeout(function(){reload_page()}, 2000);
                }else {
                    notify(data,'warning','bottom','right');
    ...
    function redirect_page(){
        location.replace(base_url+'index.php/home/home');
    }
    function refresh_page(){
        location.replace(base_url+'index.php/home/login2');
    }
    function reload_page(){
        location.replace(base_url+'index.php/home/forgot_pswd');
    }
