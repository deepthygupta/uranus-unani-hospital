        ...
        <nav class="webimenu"> 
         ...
         <ul class="ownmenu">
            ...
            <li><a href="shop.html">SHOP</a></li>
             <li class="active"><a href="offers.html">OFFER</a></li>
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="images/new-item-1.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        ...
                        <a href="pay-viewcart.html" class="btn btn-small btn-dark">ADD TO CART</a> </div>
                    </div>
                  </div>
                </li>
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="images/new-item-2.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="images/new-item-3.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="images/new-item-4.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="items-in">
                    <div class="row">
                      <div class="col-sm-4"> 
                        <!-- Image -->
                        <div class="img"> <img src="images/new-item-5.jpg" alt=""> </div>
                      </div>
                      <div class="col-sm-8">
                        <div class="details-sec"> <a href="#.">LOOSE-FIT TRENCH COAT</a> <span class="font-montserrat">129.00 USD</span> </div>
                        <!-- Rating Stars -->
...
<script src="js/jquery.flexslider-min.js"></script> <script src="js/jquery.nouislider.min.js"></script> 
