      ...
      <div class="container">
        ...
        <nav class="webimenu"> 
         ...
         <ul class="ownmenu">
            ...
            <li class="meganav" class="active"><a href="blog.html">BLOG & NEWS</a> 
              <!--======= MEGA MENU =========-->
            ...
            <div class="blog-posts medium-images">
              <ul>
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="row"> 
                    <!--  Image -->
                    <div class="col-sm-5"> <img class="img-responsive" src="images/blog-med-1.jpg" alt=""> </div>
                    
                    <!--  Post Details -->
                    <div class="col-sm-7"> <span class="tags">FASHION NEWS</span> <a href="#." class="tittle-post font-playfair">Mighty Healthy 2013 Spring/Summer</a>
                      ...
                      <a class="btn btn-small btn-dark" href="blog-details.html">READ MORE</a> 
                      <!-- Tag Icon -->
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="row"> 
                    <!--  Image -->
                    <div class="col-sm-5">
                      <section class="vid"> <img class="img-responsive" src="images/blog-med-2.jpg" alt="">
                        <div class="position-center-center"> <a href="#." class="video-btn"></a> </div>
                      </section>
                    </div>
                    
                    <!--  Post Details -->
                    <div class="col-sm-7"> <span class="tags">TRENDING NEWS</span> <a href="#." class="tittle-post font-playfair"> Standard post with featured video</a>
                      <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa. </p>
                      <!--  Post Info -->
                      <ul class="info">
                        <li><i class="fa fa-user"></i> admin</li>
                  ...
                  <div class="row"> 
                    ...
                    <div class="col-sm-5">
                      <div class="product-slides">
                        <div><img class="img-responsive" src="images/blog-med-3.jpg" alt=""></div>
                        <div><img class="img-responsive" src="images/blog-med-2.jpg" alt=""></div>
                        <div><img class="img-responsive" src="images/blog-med-1.jpg" alt=""></div>
                      </div>
                    </div>
                    
                    <!--  Post Details -->
                    <div class="col-sm-7"> <span class="tags">MOTION GRAPHIC</span> <a href="#." class="tittle-post font-playfair">Standard post with slide images</a>
                      <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa. </p>
                      <!--  Post Info -->
                      <ul class="info">
                        <li><i class="fa fa-user"></i> admin</li>
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="row"> 
                    <!--  Image -->
                    <div class="col-sm-5"> <img class="img-responsive" src="images/blog-med-4.jpg" alt=""> </div>
                    
                    <!--  Post Details -->
                    <div class="col-sm-7"> <span class="tags">MOTION GRAPHIC</span> <a href="#." class="tittle-post font-playfair">Boohoo Unitard</a>
                      <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa. </p>
                      <!--  Post Info -->
                      <ul class="info">
                        <li><i class="fa fa-user"></i> admin</li>
                ...
                <li class="animate fadeInUp" data-wow-delay="0.4s">
                  <div class="row"> 
                    <!--  Image -->
                    <div class="col-sm-5"> <img class="img-responsive" src="images/blog-med-5.jpg" alt=""> </div>
                    
                    <!--  Post Details -->
                    <div class="col-sm-7"> <span class="tags">MOTION GRAPHIC</span> <a href="#." class="tittle-post font-playfair">Plaid for Brunch</a>
                      <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa. </p>
                      <!--  Post Info -->
                      <ul class="info">
                        <li><i class="fa fa-user"></i> admin</li>
