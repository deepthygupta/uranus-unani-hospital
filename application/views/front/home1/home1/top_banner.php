    ...
    <div class="container">
    	<div class="row">
			...
			<div class="col-md-6 col-sm-6 hidden-xs">
                    <div class="thumbnail no-border no-padding thumbnail-banner size-1x2">
                        <div class="media">
                            <a class="media-link" href="#">
                                <div class="img-bg image_delay" > <img src="uploads/banner_image/10a.jpg " alt="" /></div>
                            </a>
                        </div>
                    </div>
            </div>
			...
			<div class="col-md-6 col-sm-6 hidden-xs">
                    <div class="thumbnail no-border no-padding thumbnail-banner size-1x2">
                        <div class="media">
                            <a class="media-link" href="#">
                                <div class="img-bg image_delay" ><img src="uploads/banner_image/11.jpg " alt="" /></div>
                            </a>
                        </div>
                    </div>
            </div>
			...
			<div class="col-md-6 col-sm-6 hidden-xs">
                  <div class="thumbnail no-border no-padding thumbnail-banner size-1x2">
                        <div class="media">
                            <a class="media-link" href="#">
                                <div class="img-bg image_delay" ><img src="uploads/banner_image/12.jpg " alt="" /></div>
                            </a>
                        </div>
                    </div>  
            </div>
			...
			<div class="col-md-6 col-sm-6 hidden-xs">
                    <div class="thumbnail no-border no-padding thumbnail-banner size-1x2">
                        <div class="media">
                            <a class="media-link" href="#">
                                <div class="img-bg image_delay" ><img src="uploads/banner_image/13.jpg " alt="" /></div>
                            </a>
                        </div>
                    </div>
            </div>
