...
<head>
    ...
    <title>Raw Squeezed || Recover Password</title>
            ...
            <div class="container">
                ...
                <nav class="webimenu">
                    ...
                    <ul class="ownmenu">
                        ...
                        <li class="logo1"><a href="index.html"><img src="<?php echo base_url(); ?>images/logo-hdr.png" alt="logo"></a></li>
                        <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 contact-3 animate fadeInRight" data-wow-delay="0.5s">
                        ...
                        <p>Please enter new password below to reset your old password. </p><br><br><br>
                        <div class="contact">
                            <div class="contact-form">
                                <!--======= FORM  =========-->
                                <?php
                                echo form_open(base_url() . 'index.php/home/renew_password', array(
                                    'class' => 'contact-form',
                                    'method' => 'post',
                                    'id' => 'contact_form',
                                    'role' => 'form',
                                ...
                                <li class="col-sm-6 no-margin"><span class="btn btn-dark recovery_btn">Change Password
                                                    </span>
                                </li>
