...
<div class="col-md-8">
    ...
    <form action="#">
        Schedule a date:<br>
        <input class="form_datetime" type="date" name="" placeholder="mm/dd/yyyy" required>
    </form>
...
<div class="col-md-12">
    <span class="btn btn-theme-dark" onclick="load_address_form();" style="margin-left:700px;">
