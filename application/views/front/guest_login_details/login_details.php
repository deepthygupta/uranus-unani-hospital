            ...
            <div class="container">
                ...
                <nav class="webimenu">
                    ...
                    <ul class="ownmenu">
                        ...
                        <li class="active"><a href="blog.html">BLOG & NEWS</a>
                            <!--======= MEGA MENU =========-->
                        ...
                        <!--======= Shopping Cart =========-->
                        <li class="shop-cart"><a href="#."><i class="fa fa-shopping-cart"></i></a> <span
                                    class="numb">2</span>
                            <ul class="dropdown">
                                <li>
                                    <div class="media">
                                        <div class="col-sm-6">
                                            <div class="cart-img"><a href="#"> <img class="media-object img-responsive"
                                                                                    src="../../images/item-col-img-1.jpg"
                                                                                    alt="..."> </a></div>
                                        </div>
                                        <div class="col-sm-6">
                                            <h6 class="media-heading">DRAEY TRENCH COAT</h6>
                                            <span class="price"><i class="fa fa-inr"
                                                                   aria-hidden="true"></i> 129.00</span> <span
                                                    class="qty">QTY: 01</span></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="media">
                                ...
                                <li class="no-padding no-border">
                                    <h5 class="text-center">SUBTOTAL : <i class="fa fa-inr" aria-hidden="true"></i>
                                        258.00 </h5>
                                </li>
                                <li class="no-padding no-border">
                                    <div class="row">
                                        <div class="col-xs-6"><a href="#." class="btn btn-small">VIEW CART</a></div>
                                        <div class="col-xs-6 "><a href="#." class="btn btn-1 btn-small">CHECK OUT</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="cart-ship-info">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php
                                $edit_data = $this->db->get_where('user', array('user_id' => $usr))->result_array();
    ...
    <footer>
        <div class="container">
            <div class="text-center"><a href="#."><img src="../../.images/logo.png" alt=""></a><br>
                <p class="intro-small margin-t-40">Multipurpose E-Commerce Theme is suitable for furniture store,
                    fashion shop, accessories, electric shop. We have included multiple layouts for home page to give
                    you best selections in customization.</p>
            </div>
                ...
                <div class="col-md-6">
                    <ul class="row">
                        ...
                        <li class="col-sm-6">
                            ...
                            <p><i class="fa fa-home" aria-hidden="true"></i> Sraddha speciality products, Janatha road
                                south end, Manamel temple complex Vyttila – 682019</p>
            ...
            <!-- Rights -->
            <div class="rights">
                <p>© 2017 Squeezed. All Rights Reserved. Powered By <a href="http://qproinnovations.com/"
                                                                       target="blank">QPro Innovations</a></p>
            </div>
        </div>
    </footer>
    <!-- GO TO TOP -->
