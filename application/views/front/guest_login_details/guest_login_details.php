                    ...
                    <div class="cart-ship-info">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php
                                echo form_open(base_url() . 'index.php/home/place_order_guest/', array(
                                ...
                                ?>
                                    <ul class="row">
                                        ...
                                        <li class="col-md-12">
                                            <label>LAST NAME: <?php echo $surname; ?></label>
                                        </li>
                                        <!-- LAST NAME -->
                                        <li class="col-md-12">
                                        ...
                                        <li class="col-md-12">
                                            <!-- ADDRESS -->
                                            <label>ADDRESS:<?php echo $address1; ?> ,<?php echo $city; ?>
                                        ...
                                        <!-- POSTCODE -->
                                        <li class="col-md-12">
                                            <label>PIN CODE: <?php echo $zip; ?></label>
                                        </li>


                                        <!-- PHONE -->
                                        <li class="col-md-12">
                                            <label>PHONE: <?php echo $phone; ?>
                                            </label>
                                        </li>
