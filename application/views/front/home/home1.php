...
<div id="wrap">
            ...
            <div class="container">
                ...
                <nav class="webimenu">
                    ...
                    <ul class="ownmenu">
                        ...
                        <li class="logo1"><a href="index.html"><img src="images/logo.png" alt="logo"></a></li>
						...
						<li >
                            <a href="<?php echo base_url(); ?>index.php/home/offer">
        ...
        <div class="tp-banner-container">
            <div class="tp-banner" >
                <ul>
                    ...
                    <!-- Slider 2 -->
                    <li data-transition="fade" data-slotamount="7"> <img src="images/slides/slide-3.jpg" data-bgposition="center top img-responsive" alt="" />
                        <div class="overlay"></div>
                        <!-- Layer -->
    ...
    <div class="content">
        ...
        <section class="section-p-30px add_block_2">
            <div class="container-fluid">
                <ul class="row">
                    <li class="col-sm-4 animate fadeInLeft" data-wow-delay="0.4s"> <a href="#."><img src="images/add_block_1.jpg" alt=""></a> </li>
        ...
        <div class="container">
            <ul class="row">
                ...
                <li class="col-sm-3 animate fadeInLeft" data-wow-delay="0.4s">
                    <div class="inn-sec"> <a href=""> <img class="img-responsive" src="images/collection-img-1.jpg" alt=""> <span>CLEAN</span> </a> </div>
                </li>

                <!-- Collection Add -->
                <li class="col-sm-3 animate fadeInLeft" data-wow-delay="0.6s">
                    <div class="inn-sec"> <a href="#."> <img class="img-responsive" src="images/collection-img-2.jpg" alt=""> <span>GLOW</span> </a> </div>
                </li>

                <!-- Collection Add -->
                <li class="col-sm-3 animate fadeInRight" data-wow-delay="0.4s">
                    <div class="inn-sec"> <a href="#."> <img class="img-responsive" src="images/collection-img-3.jpg" alt=""> <span>ENERGY</span> </a> </div>
                </li>

                <!-- Collection Add -->
                <li class="col-sm-3 animate fadeInRight" data-wow-delay="0.6s">
                    <div class="inn-sec"> <a href="#."> <img class="img-responsive" src="images/collection-img-4.jpg" alt=""> <span>HEAL YOUR GUT</span> </a> </div>
                </li>
            </ul>
        </div>
    </section>
                ...
                <ul class="row">
                    ...
                    <li class="col-sm-6">
                        ...
                        <ul class="f-links">
                            ...
                            <li><a href="pay-checkout.html"> CHECKOUT</a></li>
                        </ul>
