...
foreach ($event_data as $row) {
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            echo form_open(base_url() . 'index.php/admin/event/update/' . $row['event_id'], array(
            ...
            <div class="panel-body">
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="event_details" class="tab-pane fade active in">

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                    <?php echo translate('event_title'); ?>
                                </label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="demo-hor-1" value="<?php echo $row['title']; ?>" placeholder="<?php echo translate('event_title'); ?>" class="form-control required">
                                </div>
                            </div>                          
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                    <?php echo translate('event_details'); ?>
                                </label>
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="event_details" name="event_details"><?php echo $row['body']; ?></textarea>
                                </div>
                            </div>                           
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" name="date" value="<?php echo $row['event_date']; ?>" id="demo-hor-1" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                              onclick="ajax_set_full('edit', '<?php echo translate('edit_event'); ?>', '<?php echo translate('successfully_edited!'); ?>', 'event_edit', '<?php echo $row['event_id']; ?>')"><?php echo translate('reset'); ?>
                        </span>
                    </div>
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" onclick="form_submit('event_edit', '<?php echo translate('successfully_updated!'); ?>');proceed('to_add');" ><?php echo translate('update'); ?></span> 
                    </div>
                </div>
            </div>
            </form>
