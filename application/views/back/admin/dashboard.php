...
<div id="content-container" style="background-color: #fefdfb">
    <div id="page-title">
...
?>	
        ...
        <div class="row" <?php if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-4 col-lg-4" style="visibility:hidden;">
		...
		<div style="width:500px;height:auto; background-color:white;border:green 1px solid;">
		<br>
			 <h style="font-weight:900;font-size: 180%; margin-left:20px;">Most Viewed Products</h>
			 <br><br>
<!--			 <h4 style="margin-left:50px;">Products</h4><hr>-->
                        <?php
                        ...
                        <div class="media">
                                ...
                                <img width="100px" height="90px" src="<?php echo $this->crud_model->file_view('product',$row['product_id'],'100','','thumb','src','multi','one');?>" alt="">

                             <?php echo $row['title']; ?>

                            <div class="media" style="width:100px;height:100px; margin-left:220px; margin-top: -55px;";>
                                <ul>
                                    <li style="display:block;"> <?php echo $row['number_of_view'];?> &nbsp;<?php echo "views"; ?></li>
                                </ul>
                            </div>
                                <div class="rating">
                        ...
                        ?>
						<!--<div style="width:100px;height:100px;background-color:red;margin-left:400px;">-->
			</div>
...
<?php
	...
	$ago = time()-86400;
	$today_begining=strtotime('today midnight');
	$result = $this->db->get_where('stock',array('datetime >= '=>$ago,'datetime <= '=>time()))->result_array();
	$result2 = $this->db->get_where('sale',array('sale_datetime >= '=>$today_begining,'sale_datetime <= '=>time()))->result_array();
	$stock = 0;
