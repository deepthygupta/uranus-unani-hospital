			...
			?>
                <tr>
                    <td><?php echo $i; ?></td>
					 <td>
                <?php
					if(file_exists('uploads/discount_image/'.$row['image'])){
				?>
				<img class="img-md" src="<?php echo base_url(); ?>uploads/discount_image/<?php echo $row['image']; ?>" height="100px" />  
				<?php
					} else {
				?>
				<img class="img-md" src="<?php echo base_url(); ?>uploads/discount_image/default.jpg" height="100px" />
				<?php
					}
				?>
            </td>
