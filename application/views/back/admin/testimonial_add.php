<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/testimonial/do_add/', array(
                    ...
                    <div class="tab-content">
                        ...
                        <div id="testimonial_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('what_client_says??'); ?></h4>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="description" id="demo-hor-1" placeholder="<?php echo translate('description');?>" class="form-control required">
                                </div>
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('des_and_company');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="des_and_company" id="demo-hor-1" placeholder="<?php echo translate('des_and_company');?>" class="form-control required">                                </div>
                            </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_testimonial'); ?>','<?php echo translate('successfully_added!'); ?>','testimonial_add',''); "><?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('testimonial_add','<?php echo translate('testimonial_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
                    </div>
