...
<!--                            </div>-->
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-18">
                                    <?php echo translate('ingredients');?>
                                </label>
                                <div class="col-sm-6">
                                    <input type="text" name="ingredients" id="demo-hor-18" value="<?php echo $row['ingredients']; ?>" placeholder="<?php echo translate('ingredients');?>" class="form-control required">
                                </div>
                            </div>
