...
<!--                            </div>-->
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-18"><?php echo translate('ingredients');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="ingredients" id="demo-hor-1" placeholder="<?php echo translate('ingredients');?>" class="form-control required">
                                </div>
                            </div>
                                            
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-12"><?php echo translate('images');?>
                                    <div style="margin-left: -100px;"> <?php echo translate('[270x340]');?></div></label>
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?>
                                    <input type="file" multiple name="images[]" name="userfile" onchange="preview(this);" id="demo-hor-12" class="form-control required">
                                    </span>
...
<!--                            </div>-->
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-10"><?php echo translate('product_discount (if any) ');?></label>
                                <div class="col-sm-4">
