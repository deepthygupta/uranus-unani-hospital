...
foreach($testimonial_data as $row){
    ...
    <div class="row">
        <div class="col-md-12"  style="margin-top: 40px;">
            <?php
            echo form_open(base_url() . 'index.php/admin/testimonial/update/' . $row['testimonial_id'], array(
            ...
            <div class="panel-body" style="margin-top: 40px;">
                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="testimonial_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('designation_and_company');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="des_and_company" value="<?php echo $row['des_and_company']; ?>" id="demo-hor-1" placeholder="<?php echo translate('des_and_company');?>" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br><br>
                                    <span id="previewImg" >
                                        <img class="img-responsive" width="100" src="<?php echo $this->crud_model->file_view('testimonial',$row['testimonial_id'],'','','thumb','src','',''); ?>" alt="User_Image" >
                                    </span>
                                </div>
                            </div>
...
<!--                              onclick="ajax_set_full('edit','--><?php //echo translate('edit_testimonial'); ?>//','<?php //echo translate('successfully_edited!'); ?>//','testimonial_edit','<?php //echo $row['testimonial_id']; ?>//') "><?php //echo translate('reset');?>
<!--                        </span>-->
<!--                                </div>-->
<!--                                <div class="col-md-1">-->
...
<!--                            </div>-->
                    ...
                    <div class="panel-footer">
                    	...
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right"
                            ...
                            <div class="col-md-1">
                                <span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" onclick="form_submit('testimonial_edit','<?php echo translate('successfully_edited!'); ?>');proceed('to_add');" ><?php echo translate('edit');?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function get_cat(id){
        ...
        $('#sub').hide('slow');
        $('#brn').hide('slow');
        ajax_load(base_url+'index.php/admin/testimonial/sub_by_cat/'+id,'sub_cat','other');
        ajax_load(base_url+'index.php/admin/testimonial/brand_by_cat/'+id,'brand','other');
    }
