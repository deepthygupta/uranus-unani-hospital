<div class="row">
    <div class="col-md-12">
        <?php
        echo form_open(base_url() . 'index.php/admin/team_members/do_add/', array(
        ...
        <div class="panel-body">
            <div class="tab-base">
                ...
                <div class="tab-content">
                    <div id="team_add_details" class="tab-pane fade active in">
                        <div class="form-group btm_border">
                            <h4 class="text-thin text-center"><?php echo translate('Images'); ?></h4>                            
                        </div>

                        <div class="form-group btm_border">
                            <label class="col-sm-4 control-label"><?php echo translate('name'); ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="name" id="demo-hor-1" placeholder="<?php echo translate('name'); ?>" class="form-control required" autocomplete="off">
                            </div>
                        </div>                       
                        <div class="form-group btm_border">
                            <label class="col-sm-4 control-label"><?php echo translate('specialization'); ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="specialization" id="demo-hor-2" placeholder="<?php echo translate('specialization'); ?>" class="form-control required" autocomplete="off">
                            </div>
                        </div>                       
            ...
            <div class="row">
                <div class="col-md-11">
                    <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                          onclick="ajax_set_full('add', '<?php echo translate('add_members'); ?>', '<?php echo translate('successfully_added!'); ?>', 'team_add', '');"><?php echo translate('reset'); ?>
                    </span>
                </div>

                <div class="col-md-1">
                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('team_add', '<?php echo translate('member_details_added!'); ?>');proceed('to_add');" ><?php echo translate('add'); ?></span>
                </div>
            </div>
        </div>
        </form>
