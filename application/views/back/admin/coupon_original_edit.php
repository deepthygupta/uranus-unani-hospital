...
foreach($coupon_data as $row){
    ...
    <div>
        <?php
        echo form_open(base_url() . 'index.php/admin/coupon_original/update/' . $row['discount_id'], array(
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo "Coupon Limit";?></label>
                <div class="col-sm-6">
                    <input type="text" name="coupon_limit" id="demo-hor-1"  value="<?php echo $row['coupon_limit']; ?>"
                           placeholder="<?php echo "limit"; ?>" class="form-control required">
                </div>
            </div>
