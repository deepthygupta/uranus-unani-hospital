<div class="row">
    <div class="col-md-12">
        <?php
        echo form_open(base_url() . 'index.php/admin/event/do_add/', array(
                ...
                <div class="tab-content">
                    <div id="event_details" class="tab-pane fade active in">
                        <div class="form-group btm_border">
                            <h4 class="text-thin text-center"><?php echo translate('event_details'); ?></h4>                            
                        </div>
                        ...
                        <div class="form-group btm_border">
                            <label class="col-sm-4 control-label" for="demo-hor-13"><?php echo translate('event_details'); ?></label>
                            <div class="col-sm-6">
                                <textarea rows="9" name="event_details" class="summernotes" data-height="200" data-name="event_details"></textarea>
                            </div>
                        </div>      
                        <div class="form-group btm_border">
            ...
            <div class="row">
                <div class="col-md-11">
                    <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                          onclick="ajax_set_full('add', '<?php echo translate('add_event'); ?>', '<?php echo translate('successfully_added!'); ?>', 'event_add', '');"><?php echo translate('reset'); ?>
                    </span>
                </div>

                <div class="col-md-1">
                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('event_add', '<?php echo translate('event_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('add'); ?></span>
                </div>
            </div>
        </div>
        </form>
