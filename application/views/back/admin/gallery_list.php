        ...
        <tbody >
            ...
            foreach ($data as $row) {
                ...
                <tr>
                    ...
                    <td> <img class="img-responsive" width="100" src="<?php echo $this->crud_model->file_view('gallery',$row['id'],'','','thumb','src','',''); ?>" alt="User_Image" ></td>			
                    <td><?php echo $row['date']; ?></td>
                    <td class="text-right">
                        <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                           onclick="ajax_set_full('edit', '<?php echo translate('Edit'); ?>', '<?php echo translate('successfully_edited!'); ?>', 'gallery_edit', '<?php echo $row['id']; ?>');
