				...
				<div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <span id='wrap' class="pull-left" >
							...
							?>
							<img src="<?php echo base_url(); ?>uploads/discount_image/<?php echo $row['image']; ?>" width="100%" id='blah' />  
							<?php
								} else {
							?>
							<img src="<?php echo base_url(); ?>uploads/discount_image/default.jpg" width="100%" id='blah' />
							<?php
								}
							?> 
                        </span>
