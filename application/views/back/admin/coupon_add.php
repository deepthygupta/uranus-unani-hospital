    ...
    ?>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php
                        $array = array('all_products','product');
...
<!--            </div>-->
			...
			<div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('add_image');?></label>
                <div class="col-sm-6">
                    <span class="pull-left btn btn-default btn-file">
                        <?php echo translate('select image');?>
                        <input type="file" name="img" id='imgInp' accept="image">
                    </span>
                    <br><br>
                    <span id='wrap' class="pull-left" >
                        <img src="<?php echo base_url(); ?>uploads/discount_image/default.jpg" 
                        	width="48.5%" id='blah' > 
                    </span>
                </div>
            </div>
